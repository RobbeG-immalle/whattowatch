      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-2xl font-bold text-amber-400">WhatToWatch</span>
          </Link>
        ...
        <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-semibold py-3 rounded-lg hover:bg-gray-100 transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-slate-700 text-white font-semibold py-3 rounded-lg hover:bg-slate-600 transition-colors border border-slate-600"
            >
